...
class VolDb {
  static final CollectionReference collectionRef =
      FirebaseFirestore.instance.collection('VolunteerPost');

  static final CollectionReference<Map<String, dynamic>> volPostCollection =
      FirebaseFirestore.instance.collection('VolunteerPost');
  ...
  static Future<void> updatePost(
      {required VolPostModel model, required String id}) async {
    try {
      final doc = model.toJSON();
      print(id);
      print(doc);
