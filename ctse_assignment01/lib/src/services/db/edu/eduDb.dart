...
class EduDb {
  ...
  static CollectionReference<Map<String, dynamic>> _eduPostCollection =
      FirebaseFirestore.instance.collection('EducationalPost');
  ...
  static Future<void> updatePost(
      {required EduPostModel model, required String id}) async {
    try {
      final doc = model.toJSON();
      print(id);
      print(doc);
